...
class Window(QMainWindow):
	...
	def UiComponents(self):
		...
		calculate = QPushButton("계산하기", self)
	...
	def find_age(self):
		...
		self.result.setText(str(calculated_year) + " 년, " + str(calculated_month) + " 월, " + str(calculated_day) + " 일")
